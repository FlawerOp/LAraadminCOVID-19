...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $familia->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Familias", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/familias/'.$familia->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Familias", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.familias.destroy', $familia->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/familias') }}" data-toggle="tooltip" data-placement="right" title="Back to Familias"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'Integrantes')
						@la_display($module, 'Niños')
						@la_display($module, 'Descripcion')
						@la_display($module, 'Email')
						@la_display($module, 'Donacion')
					</div>
				</div>
			</div>
		</div>
